...
class MusicFavoriteViewHolder : ViewHolderProducer<FavoriteSongs, ItemFavoriteViewModel, MainCategoryItemBinding>(RV_ITEM_MUSIC_FAVORITE, FavoriteSongs::class.java, ItemFavoriteViewModel::class.java
) {
