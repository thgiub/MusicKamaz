...
class MusicFoldersViewHolder: ViewHolderProducer<AllFolderWithMusic, FolderItemViewModel, FolderItemRvBinding >(
    ...
    override fun initBinding(inflater: LayoutInflater, parent: ViewGroup) =
        FolderItemRvBinding.inflate(inflater,parent,false)
